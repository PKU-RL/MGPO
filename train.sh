...
--subsample_trajectory --subsample_min_len 10 --test_eval_interval 1000
...
--max_prompt_len 8 --K 90 --max_ep_len 90 --batch_size 64 --test_eval_interval 1000
...
--test_eval_interval 1000 --max_iters 5000